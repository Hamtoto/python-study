...
from src.face_tracker.core.monitor import TrackerMonitor
from src.face_tracker.utils.bbox import evaluate_bbox_quality
from src.face_tracker.utils.tracker import get_adaptive_reinit_interval
...
def track_and_crop_video(
    ...
    pbar = tqdm(total=total_frames, desc="얼굴크롭", ncols=60, leave=False)
